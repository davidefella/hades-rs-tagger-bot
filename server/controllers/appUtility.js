...
var helpMessage = 
    ...
    "/add4, /add5, /add6, /add7, /add8  --> Aggiunge alla lista  \r\n" +
    "/remove4, /remove5, /remove6, /remove7, /remove8  --> Rimuove dalla lista  \r\n" +
    "/rs4, /rs5, /rs6, /rs7, /rs8  -->  Tag per tutti i giocatori della lista \r\n" +
    "/list4, /list5, /list6, /list7, /list8 --> Tutti i giocatori ma senza taggare \r\n" +
